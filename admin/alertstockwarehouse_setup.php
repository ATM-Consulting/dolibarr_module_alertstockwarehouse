...
/**
 * 	\file		admin/alertstockwarehouse.php
...
require_once '../lib/alertstockwarehouse.lib.php';
 ...
 * View
 */
$page_name = "AlertStockWarehouseSetup";
...
$head = alertstockwarehouseAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104019Name"),
    0,
